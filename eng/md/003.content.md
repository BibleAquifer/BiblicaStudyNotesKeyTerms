...
* **Associated ACAI Concepts:** Believe In (ID: `keyterm:BelieveIn`); Believe (ID: `keyterm:Believe`); Trust (ID: `keyterm:LeanOn`)
## Believer (id: 132023)
...
* **Associated ACAI Concepts:** Believers (ID: `group:GenericBelievers`); Believe (ID: `keyterm:Believe`)
## Benjamin (id: 132240)
