...
* **Associated ACAI Concepts:** Hamã (ID: `person:Haman`); Hemã (ID: `person:Hemam`); Hemã (ID: `person:Heman`); Hemã (ID: `person:Heman.2`); Hemã (ID: `person:Heman.3`); Hamona (ID: `place:Hamonah`)
## Hebreu (id: 146041)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod`); Herodes (ID: `person:Herod.3`)
## Herodianos (id: 145571)

Apoiadores dos governantes da linha familiar de Herodes, o Grande.


* **Associated ACAI Concepts:** Herodians (ID: `group:Herodian`); Herodião (ID: `person:Herodion`); Herodias (ID: `person:Herodias`)
## Heveus (id: 145936)
...
* **Associated ACAI Concepts:** Hobabe (ID: `person:Hobab`); Jobabe (ID: `person:Jobab`); Jobabe (ID: `person:Jobab.2`); Jobabe (ID: `person:Jobab.3`); Jobabe (ID: `person:Jobab.4`); Jobabe (ID: `person:Jobab.5`)
