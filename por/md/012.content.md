...
* **Associated ACAI Concepts:** Laodiceia (ID: `place:Laodicea`); Laodiceans (ID: `group:Laodicea`)
...
* **Associated ACAI Concepts:** Levi (ID: `group:Levi`); Levi (ID: `person:Levi`); Levi (ID: `person:Levi.2`); Levi (ID: `person:Levi.3`)
## Levitas (id: 145852)
