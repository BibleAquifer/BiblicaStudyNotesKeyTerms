...
* **Associated ACAI Concepts:** igreja (ID: `keyterm:Church`); The Church (ID: `group:GenericChurch`)
...
* **Associated ACAI Concepts:** Isaías (ID: `person:Isaiah`); Jesoaías (ID: `person:Jeshohaiah`); Jesua (ID: `person:Jeshua`); Jesua (ID: `person:Jeshua.2`); Jesua (ID: `person:Jeshua.3`); Jesua (ID: `person:Jeshua.4`); Jesua (ID: `person:Jeshua.5`); Jesua (ID: `person:Jeshua.6`); Jesua (ID: `person:Jeshua.7`); Jesua (ID: `place:Jeshua`); Issias (ID: `person:Isshiah`); Issias (ID: `person:Isshiah.2`); Issias (ID: `person:Isshiah.3`); Issias (ID: `person:Isshiah.4`); Issias (ID: `person:Isshijah`); Jesaías (ID: `person:Jeshaiah.2`); Jesaías (ID: `person:Jeshaiah.3`); Jesaías (ID: `person:Jeshaiah.4`); Jesaías (ID: `person:Jeshaiah.5`); Jesaías (ID: `person:Jeshaiah.6`)
## Isaque (id: 145770)
