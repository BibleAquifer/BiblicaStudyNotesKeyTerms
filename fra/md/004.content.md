...
* **Associated ACAI Concepts:** Baal (ID: `deity:Baal`); Baal (ID: `person:Baal`); Baal (ID: `person:Baal.2`); Baala (ID: `place:Baalah`); Baalis (ID: `person:Baalis`)
## Baal Péor (id: 133654)
...
* **Associated ACAI Concepts:** Babylone (ID: `place:Babylon`); Babylon (ID: `place:Babylon.2`); Babylonia (ID: `place:Babylonia`); Babylonien (ID: `group:Babylon`)
## Balaam (id: 133650)
...
* **Associated ACAI Concepts:** Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Benjamin (ID: `person:Benjamin.2`); Benjamin (ID: `person:Benjamin.3`); Benjamin (ID: `person:Benjamin.4`); Benjamin (ID: `person:Benjamin.5`)
## Bérée (id: 133381)
...
* **Associated ACAI Concepts:** Bérée (ID: `place:Berea`); de Bérée (ID: `group:Berea`); Béra (ID: `person:Bera`); Beéra (ID: `person:Beera`); Beéra (ID: `person:Beerah`); Béri (ID: `person:Beri`)
## Berger (id: 133530)
...
* **Associated ACAI Concepts:** Beersheba (ID: `place:Beersheba`); Bersabe (ID: `place:Beersheba.2`)
## Béthanie (id: 133327)

La ville où vivaient Marie, Marthe et Lazare. Elle se trouvait non loin à l'est de Jérusalem et près du mont des Oliviers.


* **Associated ACAI Concepts:** Béthanie (ID: `place:Bethany`); Béthanie (ID: `place:Bethany.2`); Béthen (ID: `place:Beten`); Batanea (ID: `place:Batanea`)
## Béthel (id: 133524)
...
* **Associated ACAI Concepts:** Béthel (ID: `place:Bethel.2`); Bethel (ID: `place:Bethel`); Bethul (ID: `place:Bethul`); Béthen (ID: `place:Beten`); Bethuel (ID: `person:Bethuel`); Bethuel (ID: `place:Bethuel`)
## Bethléem (id: 133694)
