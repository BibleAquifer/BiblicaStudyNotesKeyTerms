...
* **Associated ACAI Concepts:** collecteur d'impôt (ID: `keyterm:TaxCollector`); Tax Collectors (ID: `group:TaxCollectors`)
## Colosses (id: 133412)
...
* **Associated ACAI Concepts:** Colosses (ID: `place:Colossae`); Colossians (ID: `group:Colossae`)
