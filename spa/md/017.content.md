...
* **Associated ACAI Concepts:** Rahab (ID: `person:Rahab`); Rabbah (ID: `place:Rabbah.2`); Raham (ID: `person:Raham`)
## Raquel (id: 232245)
...
* **Associated ACAI Concepts:** recaudador de impuestos (ID: `keyterm:TaxCollector`); Tax Collectors (ID: `group:TaxCollectors`)
## Reglas (id: 232178)
...
* **Associated ACAI Concepts:** rey (ID: `person:Hammelech`)
