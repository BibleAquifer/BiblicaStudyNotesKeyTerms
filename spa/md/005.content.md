...
* **Associated ACAI Concepts:** Dan (ID: `group:Dan`); Dan (ID: `person:Dan`); Dan (ID: `place:Dan`); Dan (ID: `place:Mahaneh-dan`); Dan (ID: `place:Vedan`)
## Daniel (id: 232529)
...
* **Associated ACAI Concepts:** Darío (ID: `person:Darius`); Darío (ID: `person:Darius.2`); Darío (ID: `person:Darius.3`)
## David (id: 232418)
...
* **Associated ACAI Concepts:** dios (ID: `deity:El-berith`); Jehová (ID: `deity:Lord`); divino (ID: `keyterm:Divine`)
