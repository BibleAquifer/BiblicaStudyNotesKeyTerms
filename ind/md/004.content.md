...
* **Associated ACAI Concepts:** Baal (ID: `deity:Baal`); Baal (ID: `deity:Baal-berith`); Baal (ID: `person:Baal`); Baal (ID: `person:Baal.2`)
## Baal Peor (id: 203537)
...
* **Associated ACAI Concepts:** bapa (ID: `place:Beth-gader`)
...
* **Associated ACAI Concepts:** Berea (ID: `place:Berea`); Beera (ID: `person:Beera`); Beera (ID: `person:Beerah`); Beria (ID: `person:Beriah`); Beria (ID: `person:Beriah.2`); Beria (ID: `person:Beriah.3`); Beria (ID: `person:Beriah.4`)
...
* **Associated ACAI Concepts:** Betel (ID: `place:Bethel`); Betel (ID: `place:Bethel.2`); Beten (ID: `place:Beten`)
## Betlehem (id: 203577)

Kota asal Daud dan tempat kelahiran Yesus. Letaknya tidak jauh dari sebelah selatan Yerusalem.


* **Associated ACAI Concepts:** Betlehem (ID: `person:Hareph`); Betlehem (ID: `place:Bethlehem`); Betlehem (ID: `place:Bethlehem.2`); Betlehem (ID: `place:GeruthChimham`)
## Bileam (id: 203533)
